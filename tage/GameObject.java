...
public class GameObject {
  ...
  public void yaw(int right, float time, float keyValue) {
    ...
    if (right == 1) {
      rotAroundAvatar =
        new Matrix4f().rotation(0.001f * time, new Vector3f(0f, 1f, 0f));
    } else if (right == 0){
      rotAroundAvatar =
        new Matrix4f().rotation(-0.001f * time, new Vector3f(0f, 1f, 0f));
    } else if (keyValue < -.2){
  ...
  public void pitch(boolean up, float time, float keyValue) {
    ...
    if (up || keyValue < -.2) {
      rotAroundAvatar =
        new Matrix4f().rotation(-.015f * time, new Vector3f(1f, 0f, 0f));
    } else {
      rotAroundAvatar =
        new Matrix4f().rotation(.015f * time, new Vector3f(1f, 0f, 0f));
    }
